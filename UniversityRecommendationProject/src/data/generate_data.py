...
# Code 
from .parameters import nsample, threshold, get_value_list
from .functions import *

value_lists = get_value_list()

def create_clean_data(nsample = 10,threshold=80,save_to_csv=True):
    ...
    if save_to_csv:
        df.to_csv(f'./data/raw/Generated_data_{nsample}.csv', index=False)
